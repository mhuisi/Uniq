...
\end{code}
If we were to apply our escape analysis without ct, we would obtain an infinite set of escapees $\{\icode{xs}_{[10]}, \icode{xs}_{[11, 10]}, \icode{xs}_{[11, 11, 10]}, \dots\}$, where $10$ denotes the head of cons constructor, and $11$ denotes the tail of the cons constructor.
